/****************************************************************************
** Meta object code from reading C++ file 'circleitem.h'
**
...
#error "The header file 'circleitem.h' doesn't include <QObject>."
...
const QMetaObject CircleItem::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_CircleItem.data,
      qt_meta_data_CircleItem,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *CircleItem::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CircleItem.stringdata0))
        return static_cast<void*>(const_cast< CircleItem*>(this));
    if (!strcmp(_clname, "QGraphicsEllipseItem"))
        return static_cast< QGraphicsEllipseItem*>(const_cast< CircleItem*>(this));
